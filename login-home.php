...
<html lang="en" class="js no-touch">
    <head>
        ...
        <meta name="description" content="An open Source Health Management System For Patients With HIV" />
    ...
    <body>
        <div class="container">
            <ul id="gn-menu" class="gn-menu-main">
                ...
                <li><a class="codrops-icon codrops-icon-prev" href="#"><span>Home</span></a></li>
                <li><a class="codrops-icon codrops-icon-drop" href="#"><span> Welcome back <?php echo $membersite->UserFullName(); ?></span></a></li>
            </ul>
            <header>
                <h1>Thank you for trying openHPMIS <span>Changing lives across <a href="#">Africa</a> and beyond</span></h1>	
            </header> 
        </div><!-- /container -->
